...
void R1P_IntegerPacking_Gadget::init() {
    compressionPackingGadget_ = BitPacking_Gadget::create(pb_, unpacked_, packed_,
                                                                  packingMode_);
}
...
void R1P_Comparison_Gadget::init() {
	...
	alphaDualVariablePacker_ = BitPacking_Gadget::create(pb_, alpha_u_,VariableArray(1,alpha_p_), PackingMode::UNPACK);
}
/*
    Constraint breakdown:
