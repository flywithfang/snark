...
alt_bn128_G1 operator*(const bigint<m> &lhs, const alt_bn128_G1 &g)
{
    return scalar_mul<alt_bn128_G1, m>(g, lhs);
}

template<mp_size_t m, const bigint<m>& modulus_p>
alt_bn128_G1 operator*(const Fp_model<m,modulus_p> &lhs, const alt_bn128_G1 &g)
{
    return scalar_mul<alt_bn128_G1, m>(g, lhs.as_bigint());
}
