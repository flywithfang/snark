...
void init_alt_bn128_params()
{
    ...
    std::cout<<"GMP_NUMB_BITS="<<GMP_NAIL_BITS <<","<<GMP_NUMB_BITS<<","<<GMP_LIMB_BITS <<std::endl;
    std::cout<<"sizeof(mp_limb_t)"<<sizeof(mp_limb_t)<<","<<alt_bn128_r_limbs<<std::endl;
    ...
    alt_bn128_G1::G1_zero = alt_bn128_G1(alt_bn128_Fq::zero(),
                                     alt_bn128_Fq::one(),
                                     alt_bn128_Fq::zero());
    alt_bn128_G1::G1_one = alt_bn128_G1(alt_bn128_Fq("1"),alt_bn128_Fq("2"),alt_bn128_Fq::one());
